                  ...
                  {!isResetMode ? (
                    ...
                    >
                      <div className="space-y-4">
                        <Label className="text-[10px] font-black tracking-widest uppercase text-slate-500 ml-1 italic">
                          {t("identifyWorkspace")}
                        </Label>
                      ...
                      {error && (
                        <p className="text-xs font-bold text-red-400 bg-red-500/10 p-3 rounded-xl border border-red-500/20 text-center uppercase tracking-widest italic">
                          {error}
                        </p>
                      )}
                      ...
                      >
                        <div className="space-y-2">
                          ...
                          <Input
                            value={email}
                            onChange={(e) => setEmail(e.target.value)}
                            className="h-14 rounded-2xl bg-black/40 border-slate-800 font-bold"
                            placeholder={t("email_placeholder")}
                          />
                        </div>
                        <Button
                          type="submit"
                          className="w-full h-14 rounded-2xl bg-emerald-600 font-black uppercase tracking-widest"
                        >
                          {t("requestReset")}
                        </Button>
                        <button
                          ...
                          className="w-full text-xs font-bold text-slate-500 uppercase tracking-widest font-sans"
                        >
                          {t("returnToEntry")}
                        </button>
                      </form>
