        ...
        <section className="max-w-5xl mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="hidden lg:block space-y-2 sticky top-28 h-fit">
              <h2 className="text-sm font-bold uppercase tracking-widest text-slate-500 mb-6 pl-4">
                Table of Contents
              </h2>
                ...
                <div className="space-y-1">
                  {sections.map((section) => (
                    <a
                      ...
                      className="flex items-center gap-2 group p-3 rounded-xl hover:bg-slate-800 transition-all text-sm text-slate-400 hover:text-white"
                    >
            ...
            <div className="lg:col-span-2 space-y-16">
              {sections.map((section) => (
                <div
                  ...
                  className="scroll-mt-32 border-b border-slate-800 pb-16 last:border-0 group"
                >
          ...
          <div className="bg-slate-900 border border-slate-800 p-12 rounded-[3.5rem] shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
              ...
              <Link to="/about">
                <Button
                  variant="outline"
                  className="border-slate-700 text-white hover:bg-slate-800 rounded-full px-10 py-7 font-bold text-lg transform hover:scale-105 transition-all"
                >
                  View About Us
                </Button>
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 lg:col-span-1">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Transforming healthcare interactions through secure professional
                digital systems.
              </p>
            </div>
            <div>
              <h4 className="font-bold mb-6 text-slate-300 uppercase tracking-widest text-[10px]">
                Quick Links
              </h4>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-slate-500">
                ...
                <li className="flex items-center gap-2">
                  <GlobeIcon className="w-4 h-4" /> www.lomixa.net
                </li>
              </ul>
            </div>
            <div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:bg-emerald-500/10 hover:border-emerald-500 transition-all text-slate-400 hover:text-white"
                >
