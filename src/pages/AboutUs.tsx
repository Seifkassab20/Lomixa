      ...
      <main className="pt-32 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-4 mb-32">
          <h2 className="text-3xl font-bold text-center mb-16">
            {t("about_feature_grid_title")}
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: t("about_feature_1_title"),
                desc: t("about_feature_1_desc"),
                icon: Video,
              },
              {
                title: t("about_feature_2_title"),
                desc: t("about_feature_2_desc"),
                icon: CheckCircle2,
              },
              {
                title: t("about_feature_3_title"),
                desc: t("about_feature_3_desc"),
                icon: Shield,
              },
              {
                title: t("about_feature_4_title"),
                desc: t("about_feature_4_desc"),
                icon: Users,
              },
              {
                title: t("about_feature_5_title"),
                desc: t("about_feature_5_desc"),
                icon: Globe,
              },
              {
                title: t("about_feature_6_title"),
                desc: t("about_feature_6_desc"),
                icon: CheckCircle2,
              },
            ].map((feature, i) => (
              <div
